...
@section('toggle')
<a href="{{ route('doctor procedures') }}" class="btn btn-secondary">← Procedimientos</a>
@endsection
@section('content')
<div class="container form-sm">
	<table class="table table-striped">
		<tbody>
			<tr>
				<td>
					<form class="well form-horizontal" method="post" action="{{ route('doctor store procedure') }}"> @csrf
