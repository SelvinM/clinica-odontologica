...
<div class="bg-light border-right" id="sidebar-wrapper">
  ...
  <div class="list-group list-group-flush">
    <a href="{{ route('usuarios.index') }}" class="list-group-item list-group-item-action @yield('bg dashboard link')"> @yield('dashboard selected') Usuarios</a>
    <a href="{{ route('admin materials type') }}" class="list-group-item list-group-item-action @yield('bg materials link')"> @yield('materials selected') Tipos de materiales</a>
