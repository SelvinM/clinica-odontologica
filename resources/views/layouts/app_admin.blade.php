...
<div class="bg-light border-right" id="sidebar-wrapper">
  ...
  <div class="list-group list-group-flush">
    ...
    <a href="{{ route('admin item types') }}" class="list-group-item list-group-item-action @yield('bg item types link')"> @yield('item types selected') Tipos de materiales</a>
    <a href="{{ route('admin payment methods') }}" class="list-group-item list-group-item-action @yield('bg payment methods link')">@yield('payment methods selected') Tipos de pago</a>
